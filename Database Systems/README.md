...
- ทำให้การเก็บข้อมูลเกิดการซ้ำซ้อนน้อยที่สุด
- ทำให้มีความถูกต้องมากที่สุด
- เข้าถึงข้อมูลได้ถูกต้องและทันสมัย
- ทำให้การเข้าถึงข้อมูลเป็นไปได้อย่างรวดเร็ว
...
Column หรือ Group of column ที่ไม่มีคุณสมบัติที่ uniqueness

> **Note**
> Uniqueness คือ ค่าที่ไม่ซ้ำกัน
> Minimality คือ ค่าที่ไม่สามารถลดลงได้
...
1. ทำหน้าที่แปลงคำสั่งที่ใช้จัดการกับข้อมูลภายใน database ให้อยู่ในรูปแบบที่ข้อมูลเข้าใจ
2. ทำหน้าที่ในการนำคำสั่งต่างๆ ซึ่งได้รับการแปลแล้วไปสั่งให้ database ทำงาน เช่น Add, Update หรือ Delete
3. ทำหน้าที่ป้องกันความเสียหายที่จะเกิดขึ้นกับข้อมูลใน database โดยจะคอยตรวจสอบว่าคำสั่งใดที่สามารถทำงานได้ และคำสั่งใดที่ไม่สามารถทำงานได้
4. ทำหน้าที่รักษาความสัมพันธ์ของข้อมูลภายใน database ให้มีความถูกต้องอยู่เสมอ
5. ทำหน้าที่เก็บรายละเอียดต่างๆ ที่เกี่ยวข้องกับข้อมูลภายใน database ไว้ใน data dicitionary ซึ่งรายละเอียดเหล่านี้มักจะถูกเรียกว่า ข้อมูลของข้อมูล (Meta Data)
6. ทำหน้าที่ควบคุมให้ database ได้อย่างถูกต้องและมีประสิทธิภาพ
